...
from index.v2.bm25_index import BM25Index
...
class QueryEngine:
    ...
    def __init__(self, bucket_name: Optional[str] = None):
        ...
        self.bm25_index = BM25Index.open(
            0.75,
            1.5,
            Path("db/bm25/index.pkl"),
            Path("db/bm25/posting.list")
        )
    ...
    def query(self, text: str):
        ...
        for (doc_id, score) in self.bm25_index.query(text):
